...
<li><i class="icon_large icon_triangle_right"></i></li>
<li><a href="/admin/category/edit/{{ $result['category']->cat_id }}">编辑分类</a></li>
...
<div class="body_nest">
    ...
    <div class="form_group row">
        ...
        <div class="col-lg-6">
            <input type="text" class="form_control" name="cat_name" value="{{ $result['category']->cat_name }}">
        </div>
    </div>
    <div class="form_group row">
        ...
        <div class="col-lg-4 control_select btn_group">
            <button data-toggle="d ropdown" class="btn dropdown_toggle" type="button">
                <span class="txt">{{ $result['category_info'][$result['category']->parent_id] or '请选择' }}</span><span class="icon_triangle_down"></span>
            </button>
            ...
            <input type="hidden" name="parent_id" value="{{ $result['category']->parent_id }}">
        </div>
    </div>
    <div class="form_group row">
        <label class="col-lg-2 control_label">排序：</label>
        <div class="col-lg-6">
            <input type="text" class="form_control" name="sort_order" value="{{ $result['category']->sort_order }}">
        </div>
    </div>
    <div class="form_group row">
