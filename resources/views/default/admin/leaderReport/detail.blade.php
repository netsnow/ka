...
<li><i class="icon_large icon_triangle_right"></i></li>
<li><a href="leaderreport/detail">园区学生出勤</a></li>
...
<table id="responsive-example-table" class="table large-only">
	<tbody>
		<tr class="text-right">
			<th width="18%">学生姓名</th>
			<th width="14%">实际出勤次数</th>
			<th width="14%">应出勤次数</th>
			<th width="18%">操作</th>
		</tr>
		...
		<tr>
			...
			<td>{{ $order->ac_day }}</td>
			<td>
				<a href="/admin/leaderreport/detail/" class="btn btn_blue"><i class="icon-pencil white"></i> 详情</a>
			</td>
		</tr>
		@empty
		<tr>
