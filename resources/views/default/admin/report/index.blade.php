@extends('default.admin._layout.base') @section('title', '考勤统计')
...
<div class="body_nest radius">
	...
	<table id="responsive-example-table" class="table large-only">
        ...
        <td>{{ $order->ac_day }}</td>
        <td>
            <a href="/admin/studentmanage/edit/{{ $order->phone }}" class="btn btn_blue"><i class="icon-pencil white"></i> 详情</a>
        </td>
			</tr>
			@empty
			<tr>
