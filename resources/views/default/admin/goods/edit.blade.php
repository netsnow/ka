...
@section('foot-assets')
    ...
    {!! script("assets/admin/js/goods/edit.js")!!}
    <!-- CSS -->
    ...
    <div class="body_nest">
        <form method="post" class="main-form">
            ...
            <div class="form_group row">
                <label class="col-lg-3 control_label">商品名称：</label>
              <div class="col-lg-6">
                 <input type="text" class="form_control" name="goods_name" readonly value="{{ $result['goods']->goods_name or '' }}">
              </div>
            </div>

            <div class="form_group row">
			<label class="col-lg-3 control_label">商品图片：</label>
			<div class="col-lg-3">
		   ...
		   <div class="form_group row">
              <label class="col-lg-3 control_label">商店名称：</label>
              <div class="col-lg-6">
                 <input type="text" class="form_control" name="store_name" readonly value="{{ $result['goods']->store_name or '' }}">
              </div>
           </div>
