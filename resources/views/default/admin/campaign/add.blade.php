            ...
            <div class="col-lg-6">
                <div class="form_inline">
                    <div class="form_group">
                        <input type="text" class="form_control datepicker" id="timestart" name="campaign_timestart" />
                    </div>
                    <div class="form_group"> — </div>
                    <div class="form_group">
                        <input type="text" class="form_control datepicker" id="timeend" name="campaign_timeend" />
                    </div>
                </div>
            </div>
        </div>
...
{{----}}
        ...
        <div class="form_group row">
            ...
            <div class="col-lg-1">
                <button class="btn btn_green" id="sub">提交</button>
            </div>
            <div>
...
$(function() {
   ...
   /* $('#sub').click(function(){
        alert($('#timestart').Zebra_DatePicker().val()==""? 0 :1);
    });*/
</script>
@endsection
