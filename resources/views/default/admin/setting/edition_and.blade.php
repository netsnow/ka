...
@section('title', 'App升级管理(android)')

@section('title-block')
<i class="icon_large icon_bookmark2"></i>
<span>App升级管理(android)</span>
@endsection
...
@section('breadcrumb')
    ...
    <li><i class="icon_large icon_triangle_right"></i></li>
    <li><a href="/admin/setting/edition_and">App升级管理(android)</a></li>
    <li class="back"><a class="btn btn_red" href="/admin/setting"><i class="icon_arrow_bold_left"></i>&nbsp;返回</a></li>
@endsection

@section('body-nest')
<div class="title">
    <a href="/admin/setting/edition_ios" >&nbsp;Ios版本&nbsp;</a>
    <a href="/admin/setting/edition_and" class="selected">&nbsp;Android版本&nbsp;</a>
    <div class="clear"></div>
</div>
<div class="body_nest">
