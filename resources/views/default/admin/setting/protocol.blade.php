...
@section('breadcrumb')
    ...
    <li><i class="icon_large icon_triangle_right"></i></li>
    <li><a href="/admin/setting/protocol">服务条款管理</a></li>
...
<div class="body_nest">
    <form method="post" class="main-form">
        ...
        <div class="form_group row">
            <label class="col-lg-3 control_label"><span class="must">*</span>服务条款：</label>
            <div class="col-lg-9">
...
{!! script('/assets/admin/js/setting/editProtocol.js') !!}
