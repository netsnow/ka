...
<li><i class="icon_large icon_triangle_right"></i></li>
<li><a href="/admin/seat_price/edit/{{ $result['seat_price']->seat_price_id }}">编辑工位类型</a></li>
...
<div class="body_nest">
    ...
    <div class="form_group row">
        ...
        <div class="col-lg-6">
            <input type="text" class="form_control" name="seat_price_name" value="{{ $result['seat_price']->seat_type_name or '' }}">
        </div>
    </div><!-- /.form_group -->
    ...
    <div class="form_group row">
        ...
        <div class="col-lg-6">
            <input type="text" class="form_control" name="seat_price_price" value="{{ $result['seat_price']->seat_price or '' }}">
        </div>
    ...
    <!-- <div class="form_group row">
        ...
        <div class="col-lg-6">
            <textarea rows="10" class="col-lg-12" name="describe" id="describe">{{$result['seat_price']->describe}}</textarea>
        </div>
    </div> -->
    <div class="form_group row">
